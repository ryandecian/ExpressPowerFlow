...
function requestZSF2400AC_Utils(sn, targetPower) {
    /* Initialisation des variables */
    let valueCommande = 0; /* Valeur de la commande à envoyer dans le body */
    ...
    if (targetPowerString in refPowerZSF2400AC) {
        valueCommande = refPowerZSF2400AC[targetPowerString]; /* On dit a typescript tkt, la clé existe bien dans refPowerZSF2400AC */
    }
