...
function handlePowerRange_Above_6500_security_Service(body, selectBattery, homePower /* Nombre positive car la maison consomme de l'énergie */) {
    /* Calcul du seul de déclanchement */
    const maxPowerHome = 6500; /* Puissance à atteindre */
    const thresholdPower = homePower - maxPowerHome; /* Nombre positif, il faudra le mettre négatif pour décharger les batteries */
    ...
    if (thresholdPower >= 100) {
        ...
        if (selectBattery.zendureSolarflow2400AC_N1.status === true && selectBattery.zendureSolarflow2400AC_N2.status === true) {
            ...
            /* Couche 3 : Si aucune des situation n'est rencontrée */
                ...
                console.error("[homeCharge_Controller] - handlePowerRange_Above_6500 - Erreur : Impossible de déterminer la répartition de la puissance entre les deux batteries Zendure Solarflow 2400 AC.");
                return body;
            }
        }
