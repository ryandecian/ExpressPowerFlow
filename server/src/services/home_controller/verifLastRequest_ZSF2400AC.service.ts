...
function verifLastRequest_ZSF2400AC_Service(body: BodyRequestHomeController_Type): BodyRequestHomeController_Type {
    const lastRequest_ZSF2400AC = getLastRequest_ZSF2400AC_Memory();

    /* Logique métier 1 : Vérification des données existant dans body */
